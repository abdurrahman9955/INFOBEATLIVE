  ...
  return (
    <div className='  bg-amber-500 pt-40 py-10 border-4 border-purple-950' >
      ...
      <textarea
       ...
       className=' lg:w-2/5 max-lg:w-2/3 max-md:w-4/5 max-sm:w-4/5 h-16 mt-5  text-2xl 
      ...
      hover:bg-purple-950 rounded-xl max-sm:w-3/5 mt-10 text-xl'>upload thumbnail </button>
      </div>

      <div className='flex justify-center'>
      <button type='submit' className='lg:w-1/5 max-lg:w-1/3 max-md:w-2/5  h-10
       text-slate-50 bg-lime-950
      hover:bg-slate-900 rounded-xl max-sm:w-3/5 mt-10 text-xl'>validate your video </button>
      </div>

      <div className='flex justify-center'>
      <button type='submit' className='lg:w-2/5 max-lg:w-2/3 max-md:w-4/5  h-10
       text-slate-50 bg-slate-950
      hover:bg-cyan-950 rounded-xl max-sm:w-4/5 mt-10 text-xl '>publish to the private</button>
      </div>
