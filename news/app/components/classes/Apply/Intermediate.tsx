...
const Intermediate = () => {
   ...
   return (
     <div className="flex flex-col py-5 bg-orange-500 border-4 border-black">
 
       <div className='flex justify-center'>
         <h1 className="text-xl max-sm:text-lg text-black mt-5 mb-5 font-bold ">
           Apply for Level 2 class here</h1>
       </div>
       ...
       <div className='flex justify-center'>
          <div className='flex flex-col lg:w-1/3  max-lg:w-2/4 max-md:w-5/6 mt-1
          gap-5 font-bold  sm:p-5 max-sm:p-5 '>
