...
const Instructors = () => {
  ...
  return (
    <div className='flex justify-center flex-col bg-cyan-500 pt-10 w-full font-bold
        ...
        '>now there are (0) Instructors</h1>
         ...
         bg-white border-8 border-slate-950 pt-5 max-md:w-11/12   md:text-xl '> 
              ...
              <button onClick={handleMenuClick}
               className='text-2xl text-black w-28 h-10 bg-cyan-600  
              hover:bg-lime-700 rounded font-bold border-slate-950 border-2
              '>Add new </button>
            </div>
               
               <div className=" shadow-lg w-11/12 bg-cyan-600 border-2  h-10
