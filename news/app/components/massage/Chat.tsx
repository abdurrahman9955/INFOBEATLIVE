         ...
         <div className='   w-full  h-auto'>
          ...
          <div className='h-screen overflow-y-auto    p-1  '>
           ...
           <div className='flex flex-row overflow-hidden w-5/6 mb-1 rounded-full border-2 
            border-black h-10 ml-10 max-sm:ml-5 text-sm bg-emerald-100'>
          ...
          border border-black focus:outline ' />
           ...
           <IoDuplicate className="lg:ml-40 xl:ml-60 h-7 lg:mr-10 w-10 text-emerald-950 
           mt-1 ml-3"/>
           <FaCamera className=" h-7 w-10 mr-3 ml-3 text-emerald-950 mt-1 "/>
          
          </div> 

           <MdKeyboardVoice className=" h-10 w-16 mr-3 ml-3 text-emerald-950 
