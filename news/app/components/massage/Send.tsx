...
const Send = () => {
  ...
  return (
   ...
   <div className='flex justify-center  font-bold pt-32  bg-emerald-500
   '>
      ...
      '>
            ...
            type='button' className='text-white bg-emerald-800 pt-2 w-40 h-10  mt-2 
          rounded-xl  hover:bg-gray-900 ml-2 text-2xl font-bold'>Followers </button>
         ...
         <div className='   w-full  h-auto'>
          ...
          type='button' className=' bg-emerald-800 text-white w-20 h-10  mt-2 
          rounded-xl text-2xl  text-center hover:bg-gray-950'>Voice </button>

          <button onClick={() => setSelectedRoute('Video')}
           type='button' className=' bg-emerald-800 w-20 h-10 text-white mt-2 
          rounded-xl text-2xl  text-center hover:bg-gray-950'>Video</button>

          <button  onClick={() => setSelectedRoute('Chat')}
          type='button' className='bg-emerald-800  text-white w-20 h-10  mt-2 
          rounded-xl tex-2xl   hover:bg-gray-950'>Chat </button>
