...
const Send = () => {
  ...
  return (
   ...
   <div className='flex justify-center  font-bold sm:pt-5  bg-emerald-500
   '>
      ...
      '>
            ...
            type='button' className='text-white bg-emerald-800 pb-1 w-40 h-7  mt-1
          rounded-sm  hover:bg-gray-900 ml-2 text-lg font-bold'>Followers </button>
         ...
         <div className='   w-full  h-auto'>
          ...
          type='button' className=' bg-emerald-800 text-white w-20 h-7 mt-1
          rounded-sm text-sm  text-center hover:bg-gray-950'>Voice </button>

          <button onClick={() => setSelectedRoute('Video')}
           type='button' className=' bg-emerald-800 w-20 h-7 text-white mt-1
