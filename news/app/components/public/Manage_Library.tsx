...
const Manage_Library = () => {
    return (
      <div className='flex justify-center  flex-col py-32 bg-orange-500 border-4 border-purple-950 '>
          ...
          <div className="flex justify-center">
           <div className=" flex justify-center bg-white ml-10 w-2/4 max-md:w-5/6 border-4 border-purple-950 m-4  
            " >
              ...
              border-4 border-black font-bold"> library name *</label>
              <input type="text" className="  ml-4 w-3/4 max-md:mt-10 flex-1 lg:pt-6 lg:mt-5 
               text-xl lg:pl-3 font-bold focus:outline-none" placeholder="your Library name" />
           ...
           <div className=" flex justify-center bg-white ml-10 w-2/4 max-md:w-5/6 border-4 border-purple-950 m-4  
            " >
              <div className="border-b-4 border-black mt-4 lg:w-full  ml-4 mr-4 mb-4 lg:flex flex-row">
              <label className="text-xl text-black mt-4 pl-3 pr-2  max-sm:mb-10 py-1
              border-4 border-black font-bold">library type *</label>
              <input type="text" className="  ml-4 w-3/4 max-md:mt-10 flex-1 lg:pt-6 lg:mt-5 
               text-xl lg:pl-3 font-bold focus:outline-none" placeholder="your Library type" />
              <button type="button" className="text-black bg-orange-400 px-5 lg:mt-6 
               rounded-sm max-md:mt-5 font-bold border- border-gray-500">change</button>  
              </div> 
           </div> </div>
           ...
           <div className=" flex justify-center bg-white ml-10 w-2/4 max-md:w-5/6 border-4 border-purple-950 m-4  
            " >
              <div className="border-b-4 border-black mt-4 lg:w-full  ml-4 mr-4 mb-4 lg:flex flex-row">
              <label className="text-xl text-black mt-4 pl-3 pr-2  max-sm:mb-10 py-1
              border-4 border-black font-bold">purpose of library *</label>
              <input type="text" className="  ml-4 w-3/4 max-md:mt-10 flex-1 lg:pt-6 lg:mt-5 
           ...
           <div className=" flex justify-center bg-white ml-10 w-2/4 max-md:w-5/6 border-4 border-purple-950 m-4  
            " >
              <div className="border-b-4 border-black mt-4 lg:w-full  ml-4 mr-4 mb-4 lg:flex flex-row">
              <label className="text-xl text-black mt-4 pl-3 pr-2  max-sm:mb-10 py-1
              border-4 border-black font-bold">category of library *</label>
              <input type="text" className="  ml-4 w-3/4 max-md:mt-10 flex-1 lg:pt-6 lg:mt-5 
               text-xl lg:pl-3 font-bold focus:outline-none
           ...
           <div className=" flex justify-center bg-white ml-10 w-2/4 max-md:w-5/6 border-4 border-purple-950 m-4  
            " >
              <div className="border-b-4 border-black mt-4 lg:w-full  ml-4 mr-4 mb-4 lg:flex flex-row">
              <label className="text-xl text-black mt-4 pl-3 pr-2  max-sm:mb-10 py-1
              border-4 border-black font-bold">library link *</label>
              <input type="text" className="  ml-4 w-3/4 max-md:mt-10 flex-1 lg:pt-6 lg:mt-5 
               text-xl lg:pl-3 font-bold focus:outline-none
           ...
           <div className=" flex justify-center bg-white ml-10 w-2/4 max-md:w-5/6 border-4 border-purple-950 m-4  
            " >
              <div className="border-b-4 border-black mt-4 lg:w-full  ml-4 mr-4 mb-4 lg:flex flex-row">
              <label className="text-xl text-black mt-4 pl-3 pr-2  max-sm:mb-10 py-1
              border-4 border-black font-bold">library id *</label>
              <input type="text" className="  ml-4 w-3/4 max-md:mt-10 flex-1 lg:pt-6 lg:mt-5 
               text-xl lg:pl-3 font-bold focus:outline-none
           ...
           <div className=" flex justify-center bg-white ml-10 w-2/4 max-md:w-5/6 border-4 border-purple-950 m-4  
            " >
              <div className="border-b-4 border-black mt-4 lg:w-full  ml-4 mr-4 mb-4 lg:flex flex-row">
              <label className="text-xl text-black mt-4 pl-3 pr-2  max-sm:mb-10 py-1
              border-4 border-black font-bold">library handle *</label>
              <input type="text" className="  ml-4 w-3/4 max-md:mt-10 flex-1 lg:pt-6 lg:mt-5 
               text-xl lg:pl-3 font-bold focus:outline-none
           ...
           " >
              <div className="border-b-4 border-black mt-4 lg:w-full  ml-4 mr-4 mb-4 lg:flex flex-row">
              <label className="text-xl text-black mt-4 pl-3 pr-2  max-sm:mb-10 py-1
              border-4 border-black font-bold">total readers *</label>
              <input type="text" className="  ml-4 w-3/4 max-md:mt-10 flex-1 lg:pt-6 lg:mt-5 
               text-xl lg:pl-3 font-bold focus:outline-none
           ...
           " >
              <div className="border-b-4 border-black mt-4 lg:w-full  ml-4 mr-4 mb-4 lg:flex flex-row">
              <label className="text-xl text-black mt-4 pl-3 pr-2  max-sm:mb-10 py-1
              border-4 border-black font-bold">read hours *</label>
              <input type="text" className="  ml-4 w-3/4 max-md:mt-10 flex-1 lg:pt-6 lg:mt-5 
               text-xl lg:pl-3 font-bold focus:outline-none
