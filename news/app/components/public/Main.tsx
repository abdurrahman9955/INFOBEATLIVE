...
const Main = () => {
  ...
  return (
    <div className=" w-full ">
        <div className="border-2 border-red-950 bg-emerald-500  py-1 w-full  ">
        ...
        <button onClick={() => setSelectedRoute('Studio')} type='button' className='text-xs
         text-white h-7 w-24 rounded-sm bg-gray-900 
         pl-5 pr-5      hover:bg-orange-700  max-lg:hidden
        '>studio</button>
         ...
         <div className="text-slate-950 py-1 px-5 ml-1 text-lg lg:hidden
          font-bold "> 
            ...
            {MenuVisible && 
               ...
               <li className="text-sm"><p><button onClick={() => setSelectedRoute('Studio')}
               >studio</button></p></li>
        ...
        <Link href={{pathname:'/upload'}}>
         <button onClick={() => setSelectedRoute('upload')}  type='button' className='text-xs
       ...
       <button onClick={() => setSelectedRoute('goLive')} type='button' className='text-xs
        ...
        <div>
            <div className="flex justify-between gap-2 overflow-x-auto overscroll-auto
              bg-lime-500 text-sm border
             py-1   border-red-950  " >


            
        <button onClick={() => setSelectedRoute('All')} type='button' className='text-xs
         text-white h-7  w-24 rounded-sm bg-black ml-1
