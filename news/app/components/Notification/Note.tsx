    ...
    <div className='flex justify-center flex-col sm:pt-5 w-full font-bold
     bg-emerald-500 '>
        ...
        <h1 className='flex justify-center  sm:mb-5  text-xl text-black font-bold 
          max-md:text-lg border-2 border-black bg-green-100 max-sm:text-xl
        ...
        '>all notifications will appear here</h1></div>
         ...
         bg-white border-4 border-slate-950 pt-5 max-md:w-full   md:text-xl '> 
              ...
              <div className="flex justify-center w-full ml-1 lg:ml-5 mr-20 border-slate-950 ">
               <div className=" shadow-lg w-full   
                rounded flex-initial">
                   ...
                   text-xl md:text-xl xl:text-lg '>you now have (0) notifications
