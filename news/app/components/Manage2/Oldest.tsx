   ...
   border-2 border-black  bg-green-400 '>
      ...
      border-black -600 h-auto sm:mb-16 font-bold'>
         ...
         <div className='   w-full  h-auto'>
          ...
          <button type='button' className='text-white bg-green-950 px-5 w-auto h-7  mt-1 
          rounded-sm  hover:bg-gray-900'>NewsPaper </button>

          <button type='button' className='text-white bg-green-950 px-5 w-auto h-7  mt-1 
          rounded-sm  hover:bg-gray-950'>NewsPaper </button>
          </h1> 
