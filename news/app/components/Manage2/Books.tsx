   ...
   border-2 border-black  bg-yellow-400 '>
      ...
      border-black -600 h-auto sm:mb-16 font-bold'>
         ...
         <div className='   w-full  h-auto'>
          ...
          text-xs font-bold  pb-1 bg-yellow-400'> 

          <button type='button' className='text-white bg-yellow-950 p-1 w-28 h-7  mt-1
          rounded-sm  hover:bg-gray-900'>Popular </button>
