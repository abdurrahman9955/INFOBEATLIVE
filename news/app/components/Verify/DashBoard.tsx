...
const DashBoard = () => {
  return (
    <div className='flex flex-col min-h-screen py-5 bg-emerald-500 '>
        ...
        sm:ml-10 max-sm:ml-3 ">
            ...
            <h1 className='items-center text-xs text-black border-2 m-3 border-black 
            h-auto max-w-xl lg:max-w-xl mt-5 font-bold p-1'>
          ...
          <div className='flex justify-center'>
         <div className='flex flex-col lg:w-2/4  max-lg:w-2/4 max-md:w-full m-2 mb-10
          mt-2 gap-5 font-bold   border-2  border-slate-950 sm:p-5 max-sm:p-5 '>

              <Link href={{pathname:'/Author'}}>
              <button type='button' className='w-full  text-xs bg-black text-white h-7
              rounded-sm  hover:bg-violet-950 '>Become author</button></Link>

              <Link href={{pathname:'/Streamer'}}>
              <button type='button' className='w-full  text-xs bg-black text-white h-7
              rounded-sm  hover:bg-violet-950'>Video Streamer</button></Link>

             <Link href={{pathname:'/Article_Writer'}}>
             <button type='button' className='w-full  text-xs bg-black text-white h-7
              rounded-sm  hover:bg-violet-950'> article writer </button></Link>

             <Link href={{pathname:'/Other_useful'}}>
             <button type='button' className='w-full  text-sm bg-black text-white h-7
             rounded-sm  hover:bg-violet-950 '>Other useful</button></Link>

            <Link href={{pathname:'/Mentor_Teacher'}}>
            <button type='button' className='w-full text-sm  bg-black text-white h-7
             rounded-sm hover:bg-violet-950'>Mentor or Teacher</button></Link>
     </div>
     </div>
