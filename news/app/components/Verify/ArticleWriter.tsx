...
import Articles1 from "./select/Articles1"
import Articles2 from "./select/Articles2"
import Countries2 from "@/app/components0/countries/Countries2"
import Phone2 from "@/app/components0/countries/Phone2"
...
const Author = () => {
  ...
  return (
    <div className="flex flex-col py-32  bg-sky-500 border-4 border-black">

      <div className='flex justify-center'>
        <h1 className="text-3xl max-sm:text-xl text-black mt-5 mb-5 font-bold ">
          verify your self as an Article writer</h1>
      </div>
      <div className='flex justify-center '>
        ...
        border-4 border-black p-3 ">
          ...
          in order to publish your articles to the public to all of our users both on mobile and website,
          if you fullfil our requirement you can monetize your articles to generate revenue from 
      ...
      <div className='flex justify-center'>
         <button className='lg:w-1/3 max-lg:w-2/4 max-sm:w-full h-auto  mt-5
          ...
          '
         >  <Countries2 onSelect={handleCountrySelect} /> </button>
      </div>
      ...
      <span  className=' lg:w-1/3 max-lg:w-2/4 max-sm:w-full h-14 mt-5  text-xl 
       ...
       <button className='w-auto   h-9   rounded 
        text-black'><Phone2 onSelect={handleCountryCode} /></button>
       </h1>
      </span>
      </div>
