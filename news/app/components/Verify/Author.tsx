...
import CountrySelect from "@/app/components0/countries/CountrySelect"
import PhoneCode from "@/app/components0/countries/PhoneCode"
import Author1 from "./select/Author1"
import Author2 from "./select/Author2"
import Author3 from "./select/Author3"
...
const Author = () => {
  ...
  return (
    <div className="flex flex-col py-5  bg-red-500 border-2 border-black">

      <div className='flex justify-center'>
        <h1 className="text-xl max-sm:text-lg text-black mt-3 mb-3 font-bold ">
          verify your self as an Author</h1>
      </div>
      <div className='flex justify-center '>
        <h1 className="max-w-3xl h-auto m-3 text-sm text-black mt-3 mb-5 font-bold
        border-2 border-black p-1 ">
          please fill the form below, this will help us to verify your ability and your skills 
          in order to publish your books to the public to all of our users both on mobile and website,
      ...
      <div className='flex justify-center'>
         <button className='lg:w-2/5 max-lg:w-2/4 max-sm:w-full h-auto  mt-5
          border-2 border-slate-950  text-s bg-white max-sm:m-2
          '
         >   <CountrySelect onSelect={handleCountrySelect} /> </button>
      </div>
      ...
      <span  className=' lg:w-2/5 max-lg:w-2/4 max-sm:w-full h-auto mt-5  text-sm
       ...
       <button className='w-auto   h-auto   rounded 
        text-black'><PhoneCode onSelect={handleCountryCode} /></button>
       </h1>
      </span>
      </div>
