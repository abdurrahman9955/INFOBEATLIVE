          ...
          <div className=" " >
              ...
              >
                 ...
                 <input type="text" className="flex justify-center border border-pink-950  
                  ...
                  <button className="w-24 max-sm:w-12  h-7 text-sm bg-red-800 sm:hidden
                  rounded text-white p-2  hover:bg-slate-950"><FaSearch
                   className='ml-2' /></button>
                  
                  <button type="submit" className="bg-red-800  text-slate-200
                  rounded-r-full px-4  h-7 text-xs border border-red-950 max-sm:hidden
