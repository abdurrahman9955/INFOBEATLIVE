          ...
          <div className=" " >
              ...
              >
                 ...
                 <input type="text" className="flex justify-center border border-pink-950  
                  rounded-l-full  flex-1  ml-5 pl-5 max-md:mx-3 text-xs  h-7 bg-white
                  max-sm:rounded-full max-sm:w-auto
                  " 
                  placeholder="search here  "  /> 
                  <button className="w-24 max-sm:w-12 text-sm h-7 bg-slate-950 sm:hidden
                  rounded text-white p-1  hover:bg-orange-950"><FaSearch
                   className='ml-2' /></button>
                  
                  <button type="submit" className="bg-orange-700  text-slate-200
                  rounded-r-full px-4 text-sm h-7 border border-red-950 max-sm:hidden
