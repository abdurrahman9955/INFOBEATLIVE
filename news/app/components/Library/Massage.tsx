...
const Massage = () => {
  ...
  return (
   ...
   <div className='flex justify-center  font-bold pt-5  bg-orange-500
   '>
      ...
      '>
            ...
            type='button' className='text-white bg-orange-700  w-40 h-7  mt-1
         ...
         <div className='   w-full  h-auto'>
          ...
          type='button' className='text-white bg-orange-700 pt-1 w-20 h-7  mt-1 
