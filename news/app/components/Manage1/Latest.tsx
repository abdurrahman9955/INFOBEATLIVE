...
const Latest = () => {
  return (
   ...
   <div className='flex justify-center  font-bold  border-2 border-black  bg-sky-400 '>
     
       <div className='flex flex-col w-full m-1
        bg-white mt-1  border-2 lg:w-11/12 border-black -600 h-auto sm:mb-16 font-bold'>


         <div className='   w-full  h-auto'>
          <h1 className='flex justify-center gap-1 border-b-2 border-black  text-xs
          font-bold  pb-1 bg-sky-400'> 

          
          <button type='button' className='text-white bg-sky-950 p-1 pl-6 pr-6 w-auto 
          h-7  mt-1 rounded-sm  hover:bg-gray-900'>your all latest content </button>
  
          </h1>
           
          <h1 className='flex justify-center gap-1   text-sm font-bold  
