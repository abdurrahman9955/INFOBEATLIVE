...
import Latest1 from './Small2/Latest1';
import Latest2 from './Small2/Latest2';
import Latest3 from './Small2/Latest3';
import Latest4 from './Small2/Latest4';
...
const Latest = () => {
  ...
  return (
   ...
   <div className='flex justify-center  font-bold 
    bg-pink-400 border-4 border-black'>
      ...
      border-black -600 h-auto  font-bold'>
         ...
         <div className='   w-full  h-auto'>
          ...
          <button  onClick={() => setSelectedRoute('Latest1')}
            ...
            w-auto pl-3 pr-3 h-10  mt-2 bg-pink-950
