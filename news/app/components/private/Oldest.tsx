...
import Oldest1 from './Small2/Oldest1';
import Oldest2 from './Small2/Oldest2';
import Oldest3 from './Small2/Oldest3';
import Oldest4 from './Small2/Oldest4';
...
const Oldest = () => {
  ...
  return (
   ...
   <div className='flex justify-center  font-bold 
    bg-violet-400 border-2 border-black'>
