     ...
     bg-white'>
      ...
      h-auto  font-bold'>
         ...
         <div className='   w-full  h-auto'>
          ...
          '> 
          <button type='button' className='text-white bg-yellow-700 pt-2 w-20 h-10  mt-2 
          ...
          ml-10 max-sm:ml-5 text-xl bg-yellow-100'>
          ...
          border-2 border-black focus:outline ' />
           ...
           <IoDuplicate className="lg:ml-40 xl:ml-60 h-10 lg:mr-10 w-10 text-yellow-950 mt-2 ml-3"/>
           <FaCamera className=" h-10 w-10 mr-3 ml-3 text-yellow-950 mt-2 "/>
          
          </div> 

           <MdKeyboardVoice className=" h-16 w-16 mr-3 ml-3 text-yellow-950 
