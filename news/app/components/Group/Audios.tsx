...
const Audios = () => {
  return (
   ...
   border-4 border-black  bg-red-500'>
      ...
      border-black -600 h-auto font-bold'>
         ...
         <div className='   w-full  h-auto'>
          ...
          <button type='button' className='text-white bg-red-700 p-2 w-28 h-10  mt-2 
          ...
          <h1 className='flex justify-center text-xl font-bold '>now there are (0) Audios</h1>
