  ...
  return (
   ...
   '>
       ...
       <div className='flex flex-col w-full lg:w-5/6
        bg-white mt-5  border-2 m-1 border-black -600 h-auto  font-bold'>


      <div className=' h-10 w-full  flex justify-between border-2 border-black pb-1
      '>
            <button  onClick={() => setSelectedRoute('Pick')}
            type='button' className='text-white bg-cyan-900  w-40 h-7  mt-1
          rounded-sm  hover:bg-gray-900 ml-1 text-sm font-bold'>Pick </button>

          <button  onClick={() => setSelectedRoute('Connect')}
          type='button' className='text-white bg-cyan-900  w-40 h-7  mt-1
          rounded-sm hover:bg-gray-900 mr-1 text-sm font-bold
          '>Connect  </button>
           </div>
         ...
         <div className='   w-full  h-auto'>
          ...
          type='button' className='text-white bg-cyan-900 pt-1 w-20 h-7  mt-1 
