  ...
  return (
    <div className='flex flex-col w-full h-auto pt-10 bg-yellow-400 border-4 border-black 
     '>
      ...
      <div className="   w-80 h-80 mt-10 border-4 border-slate-950
        ...
        ">
         ...
         <button type="button" className="text-xl text-black border-4 border-black
          w-32 h-12 mt-5  font-bold bg-white mr-16
         rounded shadow-2xl max-sm:px-4 hover:bg-orange-200 ">members
         </button>

         <button type="button" className="text-xl text-black border-4 border-black
          w-32 h-12  mt-5 font-bold bg-white ml-16
      ...
      <div className="flex justify-center mt-10 text-3xl text-red-950 font-bold"> <h1>
