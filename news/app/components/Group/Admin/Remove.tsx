    ...
    <div className='flex justify-center flex-col  pt-10 w-full font-bold
      '>
        ...
        <h1 className='flex justify-center mt-5 mb-5  text-5xl text-black font-bold 
          max-md:text-2xl border-4 border-black bg-orange-100
          lg:w-2/4  max-lg:w-3/4 max-md:w-11/12
        '> remove some members here</h1></div>
         <div className='flex justify-center'>
         <div className='flex flex-col    lg:w-2/4 mb-10 max-lg:w-3/4 font-bold 
         bg-emerald-100 border-8 border-slate-950 pt-5 max-md:w-11/12   md:text-xl '> 
