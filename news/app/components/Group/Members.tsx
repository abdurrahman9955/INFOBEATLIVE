...
const Members = () => {
  ...
  return (
    <div className='flex justify-center flex-col bg-fuchsia-500  w-full font-bold
     border-2 border-slate-950 '>
       
        <h1 className='flex justify-center mt-5 mb-3   text-xl text-black font-bold 
          max-md:text-lg
        '> now there are (0) Members</h1>
         <div className='flex justify-center'>

         <div className='flex flex-col    lg:w-2/4 mb-10 max-lg:w-3/4 font-bold 
         bg-white border-2 border-slate-950 pt-2 max-md:w-11/12   md:text-xl '> 
