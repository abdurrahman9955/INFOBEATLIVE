   ...
   border-4 border-black  bg-green-500'>
      ...
      border-black -600 h-auto  font-bold'>
         ...
         <div className='   w-full  h-auto'>
          ...
          rounded-xl  hover:bg-gray-900'>Voices </button>
          ...
          ml-10 max-sm:ml-5 text-xl bg-green-100'>
            ...
            <MdEmojiEmotions className="h-10 w-10 text-green-600 mt-2 ml-3"/>

          <textarea  className=' h-12 w-3/5 ml-2 mt-1 p-1 rounded-full pl-5
          border-2 border-black focus:outline ' />

           <IoDuplicate className="lg:ml-40 xl:ml-60 h-10 lg:mr-10 w-10 text-green-950 mt-2 ml-3"/>
           <FaCamera className=" h-10 w-10 mr-3 ml-3 text-green-950 mt-2 "/>
          
          </div> 

           <MdKeyboardVoice className=" h-16 w-16 mr-3 ml-3 text-green-950 
