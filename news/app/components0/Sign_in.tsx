...
const Sign_In = () => {
  ...
  return (
    <div className='bg-yellow-500 pt-40 py-10 border-4 border-purple-950 font-bold' >
      <div >
        <h1 className='flex justify-center text-5xl text-slate-950 mt-20 '>sign in with</h1>
      </div >
      ...
      hover:bg-blue-950 rounded-xl mt-2  '>sign in</button>
      </div>
      <div className='flex justify-center'>
       <Link href={{pathname: '/Sign_up'}}> <p className='text-xl mr-20 mt-1'>
        you have no an account? <span className='text-blue-950 text-2xl font-bold
        '>signUp</span></p> </Link>
      </div>

      <div className='flex justify-center'>
       <Link href={{pathname: '/Sign_in/Forgot_Password'}}> <p className='text-xl  mt-10'>
