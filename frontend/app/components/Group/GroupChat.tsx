       ...
       <div className='flex flex-col w-full
        ...
        border-black -600 h-auto  font-bold'>
         ...
         <div className='   w-full  h-auto'>
          ...
          <button type='button' className='text-white bg-lime-900 pt-1 w-20 h-7  mt-1
          rounded-sm hidden hover:bg-gray-900'>Voices </button>

          <button type='button' className='text-white bg-lime-900 pt-1 w-20 h-7  mt-1 
          rounded-sm hidden hover:bg-gray-950'>video </button>

          <button type='button' className='text-white bg-lime-900 pt-1 w-20 h-7  mt-1 
          hidden rounded-sm hover:bg-gray-900'>Chats </button>
          ...
          border border-black focus:outline ' />
           ...
           <IoDuplicate className="lg:ml-40 xl:ml-60 h-7 lg:mr-10 w-10 text-lime-950 mt-1 ml-3"/>
