...
const GroupArticlesPost = () => {
  return (
    <div className='  bg-lime-500 pt-5 py-5 border-2 border-red-950' >
      <div >
        <h1 className='flex justify-center md:text-xl text-lg text-slate-950 
        font-family-bold  font-bold'>upload & publish articles </h1>
      </div >
...
export default GroupArticlesPost