...
const GroupPhotosPost = () => {
  return (
    <div className='  bg-lime-500 pt-20 py-5 h-screen border-2 border-red-950' >
      <div >
        <h1 className='flex justify-center md:text-xl text-lg text-slate-950 
        font-family-bold  font-bold'>upload & publish photos </h1>
      </div >
      ...
      <textarea
       id="news"
       name="message"
       placeholder='write your title here ((optional))'
...
export default GroupPhotosPost