  ...
  return (
    <div className='flex flex-col w-full h-auto pt-5 bg-lime-500 border-2 border-black 
     '>
      ...
      <div className='flex justify-center'>
         <input type='text' className='lg:w-1/3 max-lg:w-2/4 max-sm:w-full h-8 p-1 mt-1
          border border-slate-950 text-sm m-2  bg-white
         '
         placeholder='group handle'  />
      </div>

      <div className='flex justify-center'>
         <label className='lg:w-1/3 max-lg:w-2/4 max-sm:w-full h-8 p-1 mt-5 
            text-xl font-bold m-2
          '
      ...
      <div className='flex justify-center'>
         <input type="text" className='lg:w-1/3 max-lg:w-2/4 max-sm:w-full h-8 p-1 mt-1
           border border-slate-950 text-sm  bg-white m-2
          '
      ...
      <div className='flex justify-center'>
         <textarea className='lg:w-1/3 max-lg:w-2/4 max-sm:w-full h-60 p-1 mt-1
           border border-slate-950 text-sm  m-2 bg-white '
