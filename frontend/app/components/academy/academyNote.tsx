  ...
  return (
    ...
    <div className='flex justify-center '>
      <h1
       ...
       academy announcements are visible to all platform users, not just students. Utilize 
       this feature to inform your academy about upcoming events, new courses, lectures, 
