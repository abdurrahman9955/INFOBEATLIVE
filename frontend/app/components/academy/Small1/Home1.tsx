...
import AcademyHomeText from '../academyText/academyHomeText';
import AcademyHomeText1 from '../academyText/academyHomeText1';
import AcademyHomeText2 from '../academyText/academyHomeText2';
import AcademyHomeText3 from '../academyText/academyHomeText3';
import AcademyHomeText4 from '../academyText/academyHomeText4';
import AcademyHomeText5 from '../academyText/academyHomeText5';
import AcademyHomeText6 from '../academyText/academyHomeText6';
import AcademyHomeText7 from '../academyText/academyHomeText7';
import AcademyHomeText8 from '../academyText/academyHomeText8';
import AcademyHomeText9 from '../academyText/academyHomeText9';
import AcademyHomeText10 from '../academyText/academyHomeText10';
...
const Home1 = () => {
  ...
  return (
    <div>
       <div className="bg-[url('/class22.png')] bg-cover bg-center min-h-screen w-full">
         <div className=' h-auto overflow-y-auto  '>

         <h1 className=' bg-gradient-to-b from-orange-500 to-lime-500 
         w-96 max-sm:w-80 max-sm:ml-5 mt-10  h-auto rounded-xl ml-10  '>
          ...
          <button className='bg-gradient-to-b from-lime-600
           to-cyan-500 w-60 h-12 rounded-full ml-10 '>
           visit  our beginner class
          </button>

          <button className='bg-gradient-to-b from-pink-600
           to-cyan-500 w-72 h-12 rounded-full ml-10 '>
         ...
         <div className='p-5'> <button className='bg-gradient-to-b from-orange-600
          ...
          <div className='bg-gradient-to-b from-orange-500 to-green-300
           w-full p-5 min-h-96 rounded-xl max-sm:w-full '>
             ...
             <FaEdit />  )}  </button>  
             {MenuVisible1 &&   (<AcademyHomeText1 /> )  }  </div>
          ...
          <div className='bg-gradient-to-b from-lime-500 to-green-300
           w-full p-5 min-h-96 rounded-xl  max-sm:w-full'>
             ...
             <FaEdit />  )}  </button>  
             {MenuVisible2 &&   (<AcademyHomeText2 /> )  }  </div>
          ...
          <div className='bg-gradient-to-b from-pink-500 to-green-300 w-full
           min-h-96 p-5 rounded-xl max-sm:w-full'>
             ...
             {MenuVisible3 &&   (<AcademyHomeText3 /> )  }  </div>
          ...
          <h1 className='bg-gradient-to-b from-red-950 to-pink-950
           ...
           w-full 5 min-h-screen rounded-xl max-sm:w-full '>
            ...
            <div className='flex flex-row'>
             ...
             <FaEdit />  )}  </button>  
             {MenuVisible4 &&   (<AcademyHomeText4 /> )  }  </div>
          ...
          <div className='bg-gradient-to-b from-orange-950 to-lime-950 hover:bg-black text-white font-normal
           w-full p-5 min-h-96 rounded-xl max-sm:w-full '>
            ...
            <div className='flex flex-row'>
             ...
             <FaEdit />  )}  </button>  
             {MenuVisible5 &&   (<AcademyHomeText5 /> )  }  </div>
          ...
          <div className='bg-gradient-to-b from-yellow-950 to-cyan-950 hover:bg-black font-normal text-white
           w-full p-5 min-h-96 rounded-xl  max-sm:w-full'>
            ...
            <div className='flex flex-row'>
             ...
             <FaEdit />  )}  </button>  
             {MenuVisible6 &&   (<AcademyHomeText6 /> )  }  </div>
          ...
          <div className=' bg-gradient-to-b from-slate-950 to-blue-950 w-full  hover:bg-black font-normal text-white
           min-h-96 p-5 rounded-xl  max-sm:w-full'>
            ...
            <div className='flex flex-row'>
             ...
             <FaEdit />  )}  </button>  
             {MenuVisible7 &&   (<AcademyHomeText7 /> )  }  </div>
          ...
          bg-gradient-to-b from-red-950 to-green-950 w-full   font-normal text-white
           min-h-96 p-5 rounded-xl  max-sm:w-full'>
            ...
            <div className='flex flex-row'>
             ...
             <FaEdit />  )}  </button>  
             {MenuVisible8 &&   (<AcademyHomeText8 /> )  }  </div>
    ...
    <div> 
          ...
          <div className='flex justify-center bg-gradient-to-b from-slate-950 to-black gap-4
           w-full p-5 min-h-40 rounded-xl max-sm:w-full text-blue-600 font-normal'>
             ...
             <FaEdit />  )}  </button>  
             {MenuVisible9 &&   (<AcademyHomeText9 /> )  }  </div>
          ...
          <div className='flex justify-center bg-gradient-to-b from-slate-950 to-black gap-4
           w-full p-5 min-h-40 rounded-xl max-sm:w-full text-blue-600 font-normal'>
             ...
             <FaEdit />  )}  </button>  
             {MenuVisible10 &&   (<AcademyHomeText10 /> )  }  </div>
