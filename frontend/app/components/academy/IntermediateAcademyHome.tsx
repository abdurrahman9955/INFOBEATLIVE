...
const IntermediateAcademyHome = () => {
 
  return (
    <div className='flex flex-col w-full h-auto pt-5 bg-pink-500 border-2 border-black 
     '>
      <div className="flex justify-center  text-xl text-white font-normal"> <h1>
      <p className=" bg-pink-700 rounded-lg p-5  ">
      crate class for intermediate students </p>
       </h1></div>
      ...
      <h1 className="max-w-3xl rounded h-auto  p-5 m-1 text-white
       bg-gradient-to-b from-pink-600 to-cyan-500
       ">
    
      <h1 className=" bg-pink-700 rounded-lg p-5  font-normal">
       <p className="text-lg">
       ...
       <p className="mt-2 text-lg  bg-pink-700 rounded-lg p-5  font-normal">
       Here's what you need to know:</p>

       <p className="mt-2 bg-pink-700 rounded-lg p-5  font-normal">
      ...
      <p className="mt-2 mb-3 bg-pink-700 rounded-lg p-5  font-normal">
      ...
      <Link href={{pathname:'/academy/intermediateAcademy'}}>
      <div className='flex justify-center'>
      <button  type='submit' className=' text-slate-50 bg-slate-950
...
export default IntermediateAcademyHome