  ...
  return (
    <div className='flex flex-col w-full h-auto pt-5 bg-orange-500 border-2 border-black 
     '>
      ...
      <p className=" bg-orange-700 rounded-lg p-5  ">
        crate class for advance students </p>
        </h1>
        </div>
      ...
      <h1 className=" bg-orange-700 rounded-lg p-5  font-normal">
       <p className="text-lg">
       ...
       <p className="mt-2 text-lg  bg-orange-700 rounded-lg p-5  font-normal">
       Here's what you need to know:</p>

       <p className="mt-2 bg-orange-700 rounded-lg p-5  font-normal">
      ...
      <p className="mt-2 mb-3 bg-orange-700 rounded-lg p-5  font-normal">
      ...
      <Link href={{pathname:'/academy/advanceAcademy'}}>
      <div className='flex justify-center'>
      <button  type='submit' className=' text-slate-50 bg-slate-950
...
export default AdvanceAcademyHome