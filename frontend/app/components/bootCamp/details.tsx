...
import BootCampDetails from './bootCampText/bootCampDetails';
    ...
    bg-lime-500 border-2 border-black'>
      ...
      border-black -600 h-auto  font-bold'>
         ...
         <div className='   w-full  h-auto'>
          ...
          <div className="bg-[url('/class10.avif')] bg-cover bg-center min-h-screen w-full">
            <div className='sm:p-10 p-2'>
              <h1 className='bg-gradient-to-b from-pink-500 to-lime-500 p-5
            ...
            <button  onClick={handleMenuClick}>    {MenuVisible ? (  <FiX />  ) : (
             <FaEdit />  )}  </button>  
             {MenuVisible &&   (<BootCampDetails /> )  }  </div>
