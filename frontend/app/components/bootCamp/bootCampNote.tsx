...
const BootCampNote = () => {
  return (
    <div className='flex flex-col bg-pink-500 text-black pt-5 border-2
    border-purple-950 '>
    ...
    <div className='flex justify-center '>
      <h1
       ...
       BootCamp announcements are visible to all platform users, not just students. Utilize 
       this feature to inform your bootCamp about upcoming events, new courses, lectures, 
