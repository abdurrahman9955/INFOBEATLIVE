  ...
  return (
   ...
   <div className='fixed top-32 max-sm:left-16 left-32  w-80  z-10 border-2
    border-slate-950 font-bold bg-orange-950 rounded-3xl'>
      ...
      <input type='number'
       placeholder='Months to finish this class'
      ...
      <div className='flex justify-center '>
      <input type='text'
       placeholder='Price for one 1 months'
       className=' w-full m-2 h-8   text-xs
        focus:outline p-1 
        bg-lime-00 font-bold
        border border-black' />
...
export default BootCampHomeText14