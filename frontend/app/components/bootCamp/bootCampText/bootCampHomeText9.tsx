  ...
  return (
   ...
   <div className='fixed top-32 max-sm:left-16 left-32 px-3 w-80 shadow-md z-10  font-bold 
    '>
      ...
      <input type='text'
       placeholder='your facebook link if you have'
      ...
      <div className='flex justify-center '>
      <input type='text'
       placeholder='your youtube link if you have'
       className=' w-full m-2 h-8   text-sm
        focus:outline p-1 
        bg-lime-00 font-bold
        border border-black' />
      ...
      <div className='flex justify-center '>
      <input type='text'
       placeholder='your linkedIn link if you have'
       className=' w-full m-2 h-8   text-sm
        focus:outline p-1 
        bg-lime-00 font-bold
        border border-black' />
...
export default BootCampHomeText9