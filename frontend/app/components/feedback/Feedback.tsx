...
const Feedback = () => {
    ...
    const  handleRatingChange = (newRating:any) => {
     ...
     return (
       <div className='flex justify-center min-h-screen  bg-lime-500 border-2 border-purple-950 '>
         ...
         max-sm:text-sm'>
           ...
           <div className='flex flex-col mt-5 gap-2 max-lg:w-3/5 lg:w-2/5 
            ...
            <label className=' text-sm font-bold pl-2 text-left mt-3 bg-white 
             border-2  border-indigo-950 rounded
            ...
            rounded'>write your topic/reason here</label>
            ...
            <textarea className='flex justify-center border-2 border-black h-48 mb-3 px-1
             ...
             <h1 className='rounded-lg text-lg p-1  bg-white border-2  border-indigo-950 font-bold max-sm:text-sm'>
                give us your rating here </h1>
                <div className='flex flex-row py-1 gap-4 pl-2'>
             {renderStars()}
             </div>
             <p className=' text-lg p-1  bg-white border-2 rounded-lg  border-indigo-950 font-bold 
             max-sm:text-sm'>your rating: {rating || 'no rating yet'}</p>
             
             <button type='submit' className='flex justify-center text-sm text-slate-50 
             mt-5 mb-20  bg-black   hover:bg-green-950  rounded-lg py-1 font-bold
