...
const Subscribers = () => {
  return (
    <div className='flex flex-col min-h-screen py-5 bg-lime-500 border-2 border-red-950'>
        ...
        <h1 className="flex justify-center mt-2 text-xl font-bold max-sm:text-lg text-slate-950">

            Please Apply For Admission Here </h1>
             <div className='flex justify-center'>
             <h1 className='items-center text-sm  border-2 m-1 border-red-950 h-auto 
            max-w-xl lg:max-w-2xl mt-5  font-bold p-1 text-slate-950 '>
         ...
         font-bold   border-2  border-red-950 sm:p-5 max-sm:p-5 '>
              ...
              rounded-sm  hover:bg-slate-950'>Verify class</button></Link>

             <Link href={{pathname:'/Class/Intermediate'}}>
             <button type='button' className='w-full text-xs  bg-slate-950 text-white h-7
              rounded-sm  hover:bg-slate-950'> Payment Method </button></Link>

             <Link href={{pathname:'/Class/Advance'}}>
             <button type='button' className='w-full  text-xs bg-slate-950 text-white h-7
             rounded-sm hover:bg-slate-950 '>Earning Dashboard</button></Link>

            <Link href={{pathname:'/Class/Admission'}}>
             <button type='button' className='w-full text-xs  bg-slate-950 text-white h-7
             rounded-sm  hover:bg-slate-950 '>View Students Review</button></Link>

            <Link href={{pathname:'/Class/Certificate'}}>
             <button type='button' className='w-full text-xs  bg-slate-950 text-white h-7
             rounded-sm  hover:bg-slate-950 '> See Students Needs Help</button></Link>
