  ...
  return (
    <div className=" w-full ">
        ...
        >ClassInfo</button>
         ...
         font-bold "> 
            ...
            {MenuVisible && 
               ...
               <li className="text-sm"><p><button onClick={() => setSelectedRoute('Subscribers')}
       ...
       <button onClick={() => setSelectedRoute('Subscribers')}
        type='button' 
        className={getButtonClass0('Subscribers')}
        >subscribe</button>
       ...
       <button onClick={() => setSelectedRoute('Exclusive')} 
       type='button' 
       className={getButtonClass('Exclusive')}
       >Exclusive</button>
       ...
       >Pricing</button>
        ...
        <button onClick={() => setSelectedRoute('Examination')} 
        type='button' 
        className={getButtonClass('Examination')}
        >Examination</button>
        ...
        >Announcement</button>
         ...
         >Help/Report</button>
          ...
          {selectedRoute === 'Videos' && <Videos />}
           ...
           {selectedRoute === 'Exclusive' && <Exclusive />}
           {selectedRoute === 'Connect' && <Connect />}
           {selectedRoute === 'Examination' && <Examination />}
