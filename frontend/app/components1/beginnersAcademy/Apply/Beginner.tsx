   ...
   return (
     <div className="flex flex-col py-5  bg-lime-500 border-2 border-black">
       ...
       <div className='flex justify-center'>
         <h1 className="text-xl max-sm:text-lg text-black   font-bold ">
           Apply for Level 1 class here</h1>
       </div>
       ...
       <div className='flex justify-center'>
          <div className='flex flex-col lg:w-1/3  max-lg:w-2/4 max-md:w-5/6 mt-2 gap-5
