...
import Pricing from '@/app/components/academy/Pricing';


const AdvanceAcademy = () => {
    ...
    <div className=" w-full ">
        ...
        >ClassInfo</button>
         ...
         font-bold "> 
            ...
            pl-5  lg:rounded-xl max-lg:rounded-l-full text-sm  max-sm:justify-center  '
