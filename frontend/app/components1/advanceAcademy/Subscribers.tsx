...
const Subscribers = () => {
  return (
    <div className='flex flex-col min-h-screen py-5 bg-orange-500 border-2 border-red-950'>
        ...
        <h1 className="flex justify-center text-xl font-bold max-sm:text-lg text-slate-950">
            ...
            <h1 className='items-center text-sm rounded-xl  border-2 m-1 border-slate-950 h-auto 
