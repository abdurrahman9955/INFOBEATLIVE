       ...
       <div className='flex flex-col w-full
        bg-white    h-auto  font-bold'>
         ...
         <div className='   w-full  h-auto'>
          ...
          text-xs font-bold  pb
          '>
             <button type='button' className='text-white bg-orange-700 pt-1 w-20 h-7 
          ...
          ml-10 max-sm:ml-5 text-sm bg-orange-100'>

            <MdEmojiEmotions className="h-7 w-10 text-yeelow-600 mt-1 ml-3"/>
