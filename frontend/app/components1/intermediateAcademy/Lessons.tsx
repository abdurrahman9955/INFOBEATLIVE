...
const Videos = () => {
  ...
  return (
   ...
   <div className='flex justify-center  font-bold  border-2 border-black  bg-pink-500'>
       ...
       <div className='flex flex-col w-full m-1
        bg-white   border-2  border-black -600 h-auto  font-bold'>
         ...
         <div className='   w-full  h-auto'>
          ...
          type='button' className='text-white bg-pink-700 px-3 w-auto h-7  mt-1
          rounded-sm  hover:bg-gray-900'>Complete </button>
          ...
          type='button' className='text-white bg-pink-700 px-3 w-auto h-7  mt-1
          rounded-sm  hover:bg-gray-900'>ComingSoon </button>
