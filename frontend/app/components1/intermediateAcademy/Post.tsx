...
const Post = () => {
  return (
    <div className='flex justify-center  pt-10 h-auto bg-pink-500 border-2 border-black' >
     ...
     <Link href={{pathname:'/academy/publish/intermediate/articles'}}>
     ...
     rounded  hover:bg-violet-950 '> publish your article</button></Link>
      ...
      <Link href={{pathname:'/academy/publish/intermediate/videos'}}>
     <button type='button' className='w-full   bg-slate-950 text-white h-7
     rounded  hover:bg-violet-950'> publish your videos </button></Link>

     <Link href={{pathname:'/academy/publish/intermediate/shorts'}}>
     <button type='button' className='w-full   bg-slate-950 text-white h-7
     rounded  hover:bg-violet-950 '> publish your short videos</button></Link>

     <Link href={{pathname:'/academy/publish/intermediate/course'}}>
     <button type='button' className='w-full   bg-slate-950 text-white h-7
