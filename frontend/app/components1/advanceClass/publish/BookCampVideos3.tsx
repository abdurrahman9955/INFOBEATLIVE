...
const BootCampVideos3 = () => {
  return (
    <div className='h-screen pt-20 bg-orange-500  py-5 border-2 border-red-950' >
      <div >
      ...
      hover:bg-purple-950 rounded-sm max-sm:w-3/5 mt-5 text-sm'>upload a thumbnail </button>
      </div>
...
export default BootCampVideos3