...
const Program = () => {
  ...
  return (
    <div className='flex flex-col min-h-screen py-5 bg-orange-500 border-2 border-black '>
      ...
      hover:bg-indigo-950 rounded-sm max-sm:w-3/5 mt-10 text-sm'>view your lectures </button>
            ...
            <h1 className='items-center text-sm text-black border-2 m-1
             border-black h-auto max-w-xl lg:max-w-2xl mt-5 rounded-xl font-bold p-1'>
              
              <p className='text-lg m-1'>Lecture Creation</p>

              <p className='text-sm m-1'>
              The Lecture feature allows instructors to schedule class and activities 
              for their class students at specific upcoming times. instructors can set up 
              live video calls, voice calls, and activities like chatting. Only instructors
              have the privilege to create and manage these lectures. students who are 
              not instructors will not have access to this feature.</p>
