...
const Post = () => {
  return (
    <div className='flex justify-center  pt-10 h-auto bg-orange-500 border-2 border-black' >
     ...
     <Link href={{pathname:'/bootCamp/publish/advance/articles'}}>
     ...
     rounded  hover:bg-violet-950 '> publish your article</button></Link>
      ...
      <Link href={{pathname:'/bootCamp/publish/advance/videos'}}>
     <button type='button' className='w-full   bg-slate-950 text-white h-7
     rounded  hover:bg-violet-950'> publish your videos </button></Link>

     <Link href={{pathname:'/bootCamp/publish/advance/shorts'}}>
     <button type='button' className='w-full   bg-slate-950 text-white h-7
     rounded  hover:bg-violet-950 '> publish your short videos</button></Link>

     <Link href={{pathname:'/bootCamp/publish/advance/course'}}>
     <button type='button' className='w-full   bg-slate-950 text-white h-7
