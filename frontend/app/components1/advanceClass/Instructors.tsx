...
const Instructors = () => {
  ...
  return (
    <div className='flex justify-center flex-col bg-orange-500 pt-5 w-full font-bold
        ...
        '>now there are (0) Instructors</h1>
         ...
         bg-white border-2 border-slate-950 pt-2 max-md:w-11/12   md:text-sm '> 
              ...
              <button onClick={handleMenuClick}
               className='text-xs text-black w-28 h-7 bg-orange-600  
              hover:bg-lime-700 rounded font-bold border-slate-950 border
              '>Add new </button>
            </div>
               
               <div className=" shadow-lg w-11/12 bg-orange-600 border  h-7
