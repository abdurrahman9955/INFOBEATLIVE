       ...
       <div className='flex flex-col w-full
        bg-white    h-auto  font-bold'>
         ...
         <div className='   w-full  h-auto'>
          ...
          '>
             <button type='button' className='text-white bg-fuchsia-700 pt-1 w-20 h-7 
              mt-1 rounded-sm  hover:bg-gray-900'>Calls </button>

          <button type='button' className='text-white bg-fuchsia-700 pt-1 w-20 h-7  mt-1 
          ...
          ml-10 max-sm:ml-5 text-sm bg-green-100'>
            ...
            <MdEmojiEmotions className="h-7 w-10 text-fuchsia-600 mt-1 ml-3"/>
          ...
          border border-black focus:outline ' />
           ...
           mt-1 ml-3"/>
           <FaCamera className=" h-7 w-10 mr-3 ml-3 text-fuchsia-950 mt-1 "/>
          
          </div> 

           <MdKeyboardVoice className=" h-10 w-10 mr-3 ml-3 text-fuchsia-950 
