...
const likeCommentVideos = express.Router();


likeCommentVideos.post('/videos/:commentId', async (req: Request, res: Response) => {
  try {
...
likeCommentVideos.get('/videos/:commentId', async (req: Request, res: Response) => {
  try {
    const commentId = req.params.commentId;
...
export default likeCommentVideos;
