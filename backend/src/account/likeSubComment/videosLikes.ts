...
const likeSubCommentVideos = express.Router();


likeSubCommentVideos.post('/text/:subCommentId', async (req: Request, res: Response) => {
  try {
...
likeSubCommentVideos.get('/text/:subCommentId', async (req: Request, res: Response) => {
  try {
    const subCommentId = req.params.subCommentId;
...
export default likeSubCommentVideos;
