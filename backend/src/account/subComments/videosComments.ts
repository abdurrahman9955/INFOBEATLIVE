...
const subCommentVideos = express.Router();

subCommentVideos.get('/videos/:commentId', async (req: Request, res: Response) => {
  try {
...
subCommentVideos.post('/videos/:commentId', async (req:Request, res: Response) => {
  try {
...
subCommentVideos.delete('/videos/:commentId', async (req:Request, res: Response) => {
  try {
...
export default subCommentVideos;
