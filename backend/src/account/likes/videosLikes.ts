...
const likeVideos = express.Router();


likeVideos.post('/videos/:postId', async (req: Request, res: Response) => {
  try {
...
likeVideos.get('/videos/:postId', async (req: Request, res: Response) => {
  try {
    const postId = req.params.postId;
