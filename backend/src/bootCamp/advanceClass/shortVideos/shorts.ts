...
const bootcampAdvanceClassShorts = Router();
...
bootcampAdvanceClassShorts.use(express.json());

// Upload Route
bootcampAdvanceClassShorts.post('/upload', upload.single('video'), async (req: UploadRequest, res: Response) => {
    try {
...
bootcampAdvanceClassShorts.get('/media/group/:groupId', async (req: Request, res: Response) => {
    try {
...
bootcampAdvanceClassShorts.get('/media/group/:groupId/user/:userId', async (req: Request, res: Response) => {
    try {
        const { classId, userId } = req.params;
...
// Get Media Route
bootcampAdvanceClassShorts.get('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Delete Media Route
bootcampAdvanceClassShorts.delete('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Update Media Route
bootcampAdvanceClassShorts.put('/media/:id', async (req: Request, res: Response) => {
    try {
        const { title, description } = req.body;
...
export default bootcampAdvanceClassShorts;