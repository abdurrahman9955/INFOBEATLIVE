...
const bootcampAdvanceClassVideoChat = express.Router();
...
bootcampAdvanceClassVideoChat.post('/sendVideoMessage/:classId/:userId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
bootcampAdvanceClassVideoChat.get('/getMessages/:classId', async (req: Request, res: Response) => {
...
bootcampAdvanceClassVideoChat.put('/updateMessage/:messageId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
bootcampAdvanceClassVideoChat.delete('/deleteMessage/:messageId', async (req: Request, res: Response) => {
  const { messageId } = req.params;
...
export default bootcampAdvanceClassVideoChat;
