...
// Initialize router
const bootcampAdvanceClassAudioChat = Router();

// Handle uploading an audio message
bootcampAdvanceClassAudioChat.post('/uploadAudio/:classId/:userId', upload, async (req: Request, res: Response) => {
  try {
    if (!req.file) {
...
bootcampAdvanceClassAudioChat.get('/getMessages/:groupId', async (req: Request, res: Response) => {
  try {
...
bootcampAdvanceClassAudioChat.put('/updateMessage/:messageId', upload, async (req: Request, res: Response) => {
  try {
...
bootcampAdvanceClassAudioChat.delete('/deleteMessage/:messageId', async (req: Request, res: Response) => {
  try {
    const { messageId } = req.params;
...
export default bootcampAdvanceClassAudioChat;
