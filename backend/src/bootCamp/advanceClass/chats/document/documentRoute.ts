...
// Initialize router
const bootcampAdvanceClassDocumentChat = Router();

// Define allowed document types
const allowedFileTypes = ['application/pdf', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document'];

// Handle uploading a document
bootcampAdvanceClassDocumentChat.post('/uploadDocument/:classId/:userId', upload, async (req: Request, res: Response) => {
  try {
    if (!req.file) {
...
bootcampAdvanceClassDocumentChat.get('/getMessages/:classId', async (req: Request, res: Response) => {
  try {
...
bootcampAdvanceClassDocumentChat.put('/updateDocument/:messageId', upload, async (req: Request, res: Response) => {
  try {
...
bootcampAdvanceClassDocumentChat.delete('/deleteDocument/:messageId', async (req: Request, res: Response) => {
  try {
    const { messageId } = req.params;
...
export default bootcampAdvanceClassDocumentChat;
