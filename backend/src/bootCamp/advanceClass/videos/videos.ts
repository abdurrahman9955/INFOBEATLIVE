...
const bootcampAdvanceClassVideos = Router();
...
bootcampAdvanceClassVideos.use(express.json());

// Upload Route
bootcampAdvanceClassVideos.post('/upload', upload.fields([{ name: 'video' }, { name: 'thumbnail', maxCount: 1 }]), async (req: UploadRequest, res: Response) => {
    try {
...
bootcampAdvanceClassVideos.get('/media/group/:groupId', async (req: Request, res: Response) => {
    try {
...
bootcampAdvanceClassVideos.get('/media/group/:groupId/user/:userId', async (req: Request, res: Response) => {
    try {
        const { classId, userId } = req.params;
...
// Get Media Route
bootcampAdvanceClassVideos.get('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Delete Media Route
bootcampAdvanceClassVideos.delete('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Update Media Route
bootcampAdvanceClassVideos.put('/media/:id', async (req: Request, res: Response) => {
    try {
        const { title, description } = req.body;
...
export default bootcampAdvanceClassVideos;