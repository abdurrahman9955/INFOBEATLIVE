...
const bootcampAdvanceClassVoiceCall = Router();

// Route for starting a voice call
bootcampAdvanceClassVoiceCall.post('/start/:userId/:classId', async (req, res) => {
...
bootcampAdvanceClassVoiceCall.post('/end/:callId', async (req, res) => {
...
bootcampAdvanceClassVoiceCall.post('/join/:callId/:userId', async (req, res) => {
...
bootcampAdvanceClassVoiceCall.post('/leave/:callId/:userId', async (req, res) => {
  const { callId, userId } = req.params;
  try {
...
export default bootcampAdvanceClassVoiceCall;
