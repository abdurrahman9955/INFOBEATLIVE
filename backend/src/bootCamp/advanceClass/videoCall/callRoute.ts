...
const bootcampAdvanceClassVideoCall = Router();

// Route for starting a video call
bootcampAdvanceClassVideoCall.post('/start/:userId/:classId', async (req, res) => {
...
bootcampAdvanceClassVideoCall.post('/end/:callId', async (req, res) => {
...
bootcampAdvanceClassVideoCall.post('/join/:callId/:userId', async (req, res) => {
...
bootcampAdvanceClassVideoCall.post('/leave/:callId/:userId', async (req, res) => {
  const { callId, userId } = req.params;
  try {
...
export default bootcampAdvanceClassVideoCall;
