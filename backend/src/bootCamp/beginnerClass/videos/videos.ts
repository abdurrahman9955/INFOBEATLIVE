...
const bootcampBeginnerClassVideos = Router();
...
bootcampBeginnerClassVideos.use(express.json());

// Upload Route
bootcampBeginnerClassVideos.post('/upload', upload.fields([{ name: 'video' }, { name: 'thumbnail', maxCount: 1 }]), async (req: UploadRequest, res: Response) => {
    try {
...
bootcampBeginnerClassVideos.get('/media/group/:groupId', async (req: Request, res: Response) => {
    try {
...
bootcampBeginnerClassVideos.get('/media/group/:groupId/user/:userId', async (req: Request, res: Response) => {
    try {
        const { classId, userId } = req.params;
...
// Get Media Route
bootcampBeginnerClassVideos.get('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Delete Media Route
bootcampBeginnerClassVideos.delete('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Update Media Route
bootcampBeginnerClassVideos.put('/media/:id', async (req: Request, res: Response) => {
    try {
        const { title, description } = req.body;
...
export default bootcampBeginnerClassVideos;