...
const bootcampBeginnerClassVideoChat = express.Router();
...
bootcampBeginnerClassVideoChat.post('/sendVideoMessage/:classId/:userId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
bootcampBeginnerClassVideoChat.get('/getMessages/:classId', async (req: Request, res: Response) => {
...
bootcampBeginnerClassVideoChat.put('/updateMessage/:messageId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
bootcampBeginnerClassVideoChat.delete('/deleteMessage/:messageId', async (req: Request, res: Response) => {
  const { messageId } = req.params;
...
export default bootcampBeginnerClassVideoChat;
