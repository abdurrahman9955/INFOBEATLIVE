...
const bootcampBeginnerClassRecordingChat = express.Router();
...
bootcampBeginnerClassRecordingChat.post('/sendRecordingMessage/:classId/:userId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
bootcampBeginnerClassRecordingChat.get('/getRecordingMessages/:groupId', async (req: Request, res: Response) => {
...
bootcampBeginnerClassRecordingChat.put('/updateRecordingMessage/:messageId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
bootcampBeginnerClassRecordingChat.delete('/deleteRecordingMessage/:messageId', async (req: Request, res: Response) => {
  const { messageId } = req.params;
...
export default bootcampBeginnerClassRecordingChat;
