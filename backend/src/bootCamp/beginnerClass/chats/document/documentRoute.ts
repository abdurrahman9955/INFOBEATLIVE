...
// Initialize router
const bootcampBeginnerClassDocumentChat = Router();

// Define allowed document types
const allowedFileTypes = ['application/pdf', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document'];

// Handle uploading a document
bootcampBeginnerClassDocumentChat.post('/uploadDocument/:classId/:userId', upload, async (req: Request, res: Response) => {
  try {
    if (!req.file) {
...
bootcampBeginnerClassDocumentChat.get('/getMessages/:classId', async (req: Request, res: Response) => {
  try {
...
bootcampBeginnerClassDocumentChat.put('/updateDocument/:messageId', upload, async (req: Request, res: Response) => {
  try {
...
bootcampBeginnerClassDocumentChat.delete('/deleteDocument/:messageId', async (req: Request, res: Response) => {
  try {
    const { messageId } = req.params;
...
export default bootcampBeginnerClassDocumentChat;
