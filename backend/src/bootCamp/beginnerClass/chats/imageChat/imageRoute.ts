...
const bootcampBeginnerClassImageChat = express.Router();

// Upload and send image message (Create)
bootcampBeginnerClassImageChat.post('/messages/:classId/:userId', (req: Request, res: Response) => {
...
bootcampBeginnerClassImageChat.get('/messages/:classId', async (req: Request, res: Response) => {
  try {
...
bootcampBeginnerClassImageChat.put('/messages/:messageId', (req: Request, res: Response) => {
  upload(req, res, async (err) => {
    if (err) {
      console.error('File upload error:', err);
      return res.status(500).send('Error uploading file.');
...
bootcampBeginnerClassImageChat.delete('/messages/:messageId', async (req: Request, res: Response) => {
  try {
    const { messageId } = req.params;
...
export default bootcampBeginnerClassImageChat;
