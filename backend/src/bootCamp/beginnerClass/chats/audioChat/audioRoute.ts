...
// Initialize router
const bootcampBeginnerClassAudioChat = Router();

// Handle uploading an audio message
bootcampBeginnerClassAudioChat.post('/uploadAudio/:classId/:userId', upload, async (req: Request, res: Response) => {
  try {
    if (!req.file) {
...
bootcampBeginnerClassAudioChat.get('/getMessages/:groupId', async (req: Request, res: Response) => {
  try {
...
bootcampBeginnerClassAudioChat.put('/updateMessage/:messageId', upload, async (req: Request, res: Response) => {
  try {
...
bootcampBeginnerClassAudioChat.delete('/deleteMessage/:messageId', async (req: Request, res: Response) => {
  try {
    const { messageId } = req.params;
...
export default bootcampBeginnerClassAudioChat;
