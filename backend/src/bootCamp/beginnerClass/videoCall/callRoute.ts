...
const bootcampBeginnerClassVideoCall = Router();

// Route for starting a video call
bootcampBeginnerClassVideoCall.post('/start/:userId/:classId', async (req, res) => {
...
bootcampBeginnerClassVideoCall.post('/end/:callId', async (req, res) => {
...
bootcampBeginnerClassVideoCall.post('/join/:callId/:userId', async (req, res) => {
...
bootcampBeginnerClassVideoCall.post('/leave/:callId/:userId', async (req, res) => {
  const { callId, userId } = req.params;
  try {
...
export default bootcampBeginnerClassVideoCall;
