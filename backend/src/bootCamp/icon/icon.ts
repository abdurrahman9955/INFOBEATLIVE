...
class ClassController {
  ...
  async updateIcon(req: Request, res: Response) {
    try {
      ...
      const iconUrl = await ClassService.updateClassIcon(bootcampId, iconFile, mimeType);
  ...
  async deleteIcon(req: Request, res: Response) {
    try {
      ...
      await ClassService.deleteClassIcon(bootcampId);
  ...
  async getIcon(req: Request, res: Response) {
    try {
      ...
      const iconUrl = await ClassService.getClassIcon(bootcampId);
      if (!iconUrl) {
