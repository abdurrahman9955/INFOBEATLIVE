...
bootcampVideos.use(express.json());

// Upload Route
bootcampVideos.post('/upload', upload.fields([{ name: 'video' }, { name: 'thumbnail', maxCount: 1 }]), async (req: UploadRequest, res: Response) => {
    try {
...
bootcampVideos.get('/media/group/:groupId', async (req: Request, res: Response) => {
    try {
...
bootcampVideos.get('/media/group/:groupId/user/:userId', async (req: Request, res: Response) => {
    try {
        const { bootcampId, userId } = req.params;
...
// Get Media Route
bootcampVideos.get('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Delete Media Route
bootcampVideos.delete('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Update Media Route
bootcampVideos.put('/media/:id', async (req: Request, res: Response) => {
    try {
        const { title, description } = req.body;
