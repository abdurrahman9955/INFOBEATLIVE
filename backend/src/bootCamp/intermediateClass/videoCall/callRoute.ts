...
const bootcampIntermediateClassVideoCall = Router();

// Route for starting a video call
bootcampIntermediateClassVideoCall.post('/start/:userId/:classId', async (req, res) => {
...
bootcampIntermediateClassVideoCall.post('/end/:callId', async (req, res) => {
...
bootcampIntermediateClassVideoCall.post('/join/:callId/:userId', async (req, res) => {
...
bootcampIntermediateClassVideoCall.post('/leave/:callId/:userId', async (req, res) => {
  const { callId, userId } = req.params;
  try {
...
export default bootcampIntermediateClassVideoCall;
