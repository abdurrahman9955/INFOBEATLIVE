...
const bootcampIntermediateClassVideoChat = express.Router();
...
bootcampIntermediateClassVideoChat.post('/sendVideoMessage/:classId/:userId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
bootcampIntermediateClassVideoChat.get('/getMessages/:classId', async (req: Request, res: Response) => {
...
bootcampIntermediateClassVideoChat.put('/updateMessage/:messageId', upload.single('file'), async (req: Request, res: Response) => {
  try {
    ...
    if (file) {
      ...
      updatedMessage = await prisma.bootcampClassChat.update({
        where: { id: messageId,
          level:'INTERMEDIATE',
         },
...
bootcampIntermediateClassVideoChat.delete('/deleteMessage/:messageId', async (req: Request, res: Response) => {
  const { messageId } = req.params;
...
export default bootcampIntermediateClassVideoChat;
