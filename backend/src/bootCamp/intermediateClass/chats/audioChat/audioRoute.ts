...
// Initialize router
const bootcampIntermediateClassAudioChat = Router();

// Handle uploading an audio message
bootcampIntermediateClassAudioChat.post('/uploadAudio/:classId/:userId', upload, async (req: Request, res: Response) => {
  try {
    if (!req.file) {
...
bootcampIntermediateClassAudioChat.get('/getMessages/:groupId', async (req: Request, res: Response) => {
  try {
...
bootcampIntermediateClassAudioChat.put('/updateMessage/:messageId', upload, async (req: Request, res: Response) => {
  try {
...
bootcampIntermediateClassAudioChat.delete('/deleteMessage/:messageId', async (req: Request, res: Response) => {
  try {
    const { messageId } = req.params;
...
export default bootcampIntermediateClassAudioChat;
