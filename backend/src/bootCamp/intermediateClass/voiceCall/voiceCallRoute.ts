...
const bootcampIntermediateClassVoiceCall = Router();

// Route for starting a voice call
bootcampIntermediateClassVoiceCall.post('/start/:userId/:classId', async (req, res) => {
...
bootcampIntermediateClassVoiceCall.post('/end/:callId', async (req, res) => {
...
bootcampIntermediateClassVoiceCall.post('/join/:callId/:userId', async (req, res) => {
...
bootcampIntermediateClassVoiceCall.post('/leave/:callId/:userId', async (req, res) => {
  const { callId, userId } = req.params;
  try {
...
export default bootcampIntermediateClassVoiceCall;
