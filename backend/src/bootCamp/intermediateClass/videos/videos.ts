...
const bootcampIntermediateClassVideos = Router();
...
bootcampIntermediateClassVideos.use(express.json());

// Upload Route
bootcampIntermediateClassVideos.post('/upload', upload.fields([{ name: 'video' }, { name: 'thumbnail', maxCount: 1 }]), async (req: UploadRequest, res: Response) => {
    try {
...
bootcampIntermediateClassVideos.get('/media/group/:groupId', async (req: Request, res: Response) => {
    try {
...
bootcampIntermediateClassVideos.get('/media/group/:groupId/user/:userId', async (req: Request, res: Response) => {
    try {
        const { classId, userId } = req.params;
...
// Get Media Route
bootcampIntermediateClassVideos.get('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Delete Media Route
bootcampIntermediateClassVideos.delete('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Update Media Route
bootcampIntermediateClassVideos.put('/media/:id', async (req: Request, res: Response) => {
    try {
        const { title, description } = req.body;
...
export default bootcampIntermediateClassVideos;