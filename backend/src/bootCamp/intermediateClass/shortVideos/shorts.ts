...
const bootcampIntermediateClassShorts = Router();
...
bootcampIntermediateClassShorts.use(express.json());

// Upload Route
bootcampIntermediateClassShorts.post('/upload', upload.single('video'), async (req: UploadRequest, res: Response) => {
    try {
...
bootcampIntermediateClassShorts.get('/media/group/:groupId', async (req: Request, res: Response) => {
    try {
...
bootcampIntermediateClassShorts.get('/media/group/:groupId/user/:userId', async (req: Request, res: Response) => {
    try {
        const { classId, userId } = req.params;
...
// Get Media Route
bootcampIntermediateClassShorts.get('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Delete Media Route
bootcampIntermediateClassShorts.delete('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Update Media Route
bootcampIntermediateClassShorts.put('/media/:id', async (req: Request, res: Response) => {
    try {
        const { title, description } = req.body;
...
export default bootcampIntermediateClassShorts;