...
const academyIntermediateClassShorts = Router();
...
academyIntermediateClassShorts.use(express.json());

// Upload Route
academyIntermediateClassShorts.post('/upload', upload.single('video'), async (req: UploadRequest, res: Response) => {
    try {
...
academyIntermediateClassShorts.get('/media/group/:groupId', async (req: Request, res: Response) => {
    try {
...
academyIntermediateClassShorts.get('/media/group/:groupId/user/:userId', async (req: Request, res: Response) => {
    try {
        const { classId, userId } = req.params;
...
// Get Media Route
academyIntermediateClassShorts.get('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Delete Media Route
academyIntermediateClassShorts.delete('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Update Media Route
academyIntermediateClassShorts.put('/media/:id', async (req: Request, res: Response) => {
    try {
        const { title, description } = req.body;
...
export default academyIntermediateClassShorts;