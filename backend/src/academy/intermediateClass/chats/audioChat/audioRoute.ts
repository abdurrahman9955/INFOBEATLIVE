...
// Initialize router
const academyIntermediateClassAudioChat = Router();

// Handle uploading an audio message
academyIntermediateClassAudioChat.post('/uploadAudio/:classId/:userId', upload, async (req: Request, res: Response) => {
  try {
    if (!req.file) {
...
academyIntermediateClassAudioChat.get('/getMessages/:groupId', async (req: Request, res: Response) => {
  try {
...
academyIntermediateClassAudioChat.put('/updateMessage/:messageId', upload, async (req: Request, res: Response) => {
  try {
...
academyIntermediateClassAudioChat.delete('/deleteMessage/:messageId', async (req: Request, res: Response) => {
  try {
    const { messageId } = req.params;
...
export default academyIntermediateClassAudioChat;
