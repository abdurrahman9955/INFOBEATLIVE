...
const academyIntermediateClassCourseVideos = Router();
...
academyIntermediateClassCourseVideos.use(express.json());

// Upload Route
academyIntermediateClassCourseVideos.post('/upload', upload.single('video'), async (req: UploadRequest, res: Response) => {
    try {
...
academyIntermediateClassCourseVideos.get('/media/course/:courseId', async (req: Request, res: Response) => {
    try {
...
academyIntermediateClassCourseVideos.get('/media/course/:courseId/user/:userId', async (req: Request, res: Response) => {
    try {
        const { sectionId, instructorId } = req.params;
...
// Get Media Route
academyIntermediateClassCourseVideos.get('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Delete Media Route
academyIntermediateClassCourseVideos.delete('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Update Media Route
academyIntermediateClassCourseVideos.put('/media/:id', async (req: Request, res: Response) => {
    try {
        const { title } = req.body;
        const { sectionId, instructorId } = req.params;
...
export default academyIntermediateClassCourseVideos;