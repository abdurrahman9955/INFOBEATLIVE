...
export const createSection = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const section = await prisma.academyCourseSection.create({
      data: {
        title,
        instructorId,
        description,
...
export const getAllSections = async (req: Request, res: Response) => {
  try {
    const courses = await prisma.academyCourseSection.findMany({
      where: { 
        level:'INTERMEDIATE',
       }, 
      include: {
...
export const getSectionById = async (req: Request, res: Response) => {
  ...
  try {
    const course = await prisma.academyCourseSection.findUnique({
      where: { id,
               courseId,
               instructorId,
               level:'INTERMEDIATE',
...
export const updateSection = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const updatedCourse = await prisma.academyCourseSection.update({
      where: { id,
               courseId,
               instructorId,
               level:'INTERMEDIATE',
...
export const deleteSection = async (req: Request, res: Response) => {
  ...
  try {
    await prisma.academyCourseSection.delete({
      where: { id,
       courseId,
       instructorId,
       level:'INTERMEDIATE',
