...
const academyIntermediateClassVideoCall = Router();

// Route for starting a video call
academyIntermediateClassVideoCall.post('/start/:userId/:classId', async (req, res) => {
...
academyIntermediateClassVideoCall.post('/end/:callId', async (req, res) => {
...
academyIntermediateClassVideoCall.post('/join/:callId/:userId', async (req, res) => {
...
academyIntermediateClassVideoCall.post('/leave/:callId/:userId', async (req, res) => {
  const { callId, userId } = req.params;
  try {
...
export default academyIntermediateClassVideoCall;
