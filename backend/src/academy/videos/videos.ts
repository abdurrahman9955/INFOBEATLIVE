...
const academyVideosRouter = Router();
...
academyVideosRouter.use(express.json());

// Upload Route
academyVideosRouter.post('/upload', upload.fields([{ name: 'video' }, { name: 'thumbnail', maxCount: 1 }]), async (req: UploadRequest, res: Response) => {
    try {
...
academyVideosRouter.get('/media/group/:groupId', async (req: Request, res: Response) => {
    try {
...
academyVideosRouter.get('/media/group/:groupId/user/:userId', async (req: Request, res: Response) => {
    try {
        const { academyId, userId } = req.params;
...
// Get Media Route
academyVideosRouter.get('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Delete Media Route
academyVideosRouter.delete('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Update Media Route
academyVideosRouter.put('/media/:id', async (req: Request, res: Response) => {
    try {
        const { title, description } = req.body;
...
export default academyVideosRouter;