...
const academyAdvanceClassVoiceCall = Router();

// Route for starting a voice call
academyAdvanceClassVoiceCall.post('/start/:userId/:classId', async (req, res) => {
...
academyAdvanceClassVoiceCall.post('/end/:callId', async (req, res) => {
...
academyAdvanceClassVoiceCall.post('/join/:callId/:userId', async (req, res) => {
...
academyAdvanceClassVoiceCall.post('/leave/:callId/:userId', async (req, res) => {
  const { callId, userId } = req.params;
  try {
...
export default academyAdvanceClassVoiceCall;
