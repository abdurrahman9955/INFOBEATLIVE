...
const academyAdvanceClassCourseVideos = Router();
...
academyAdvanceClassCourseVideos.use(express.json());

// Upload Route
academyAdvanceClassCourseVideos.post('/upload', upload.single('video'), async (req: UploadRequest, res: Response) => {
    try {
...
academyAdvanceClassCourseVideos.get('/media/course/:courseId', async (req: Request, res: Response) => {
    try {
...
academyAdvanceClassCourseVideos.get('/media/course/:courseId/user/:userId', async (req: Request, res: Response) => {
    try {
        const { sectionId, instructorId } = req.params;
...
// Get Media Route
academyAdvanceClassCourseVideos.get('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Delete Media Route
academyAdvanceClassCourseVideos.delete('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Update Media Route
academyAdvanceClassCourseVideos.put('/media/:id', async (req: Request, res: Response) => {
    try {
        const { title } = req.body;
        const { sectionId, instructorId } = req.params;
...
export default academyAdvanceClassCourseVideos;