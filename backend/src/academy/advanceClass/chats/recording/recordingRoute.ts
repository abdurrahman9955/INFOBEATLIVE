...
const academyAdvanceClassRecordingChat = express.Router();
...
academyAdvanceClassRecordingChat.post('/sendRecordingMessage/:classId/:userId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
academyAdvanceClassRecordingChat.get('/getRecordingMessages/:groupId', async (req: Request, res: Response) => {
...
academyAdvanceClassRecordingChat.put('/updateRecordingMessage/:messageId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
academyAdvanceClassRecordingChat.delete('/deleteRecordingMessage/:messageId', async (req: Request, res: Response) => {
  const { messageId } = req.params;
...
export default academyAdvanceClassRecordingChat;
