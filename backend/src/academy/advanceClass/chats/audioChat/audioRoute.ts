...
// Initialize router
const academyAdvanceClassAudioChat = Router();

// Handle uploading an audio message
academyAdvanceClassAudioChat.post('/uploadAudio/:classId/:userId', upload, async (req: Request, res: Response) => {
  try {
    if (!req.file) {
...
academyAdvanceClassAudioChat.get('/getMessages/:groupId', async (req: Request, res: Response) => {
  try {
...
academyAdvanceClassAudioChat.put('/updateMessage/:messageId', upload, async (req: Request, res: Response) => {
  try {
...
academyAdvanceClassAudioChat.delete('/deleteMessage/:messageId', async (req: Request, res: Response) => {
  try {
    const { messageId } = req.params;
...
export default academyAdvanceClassAudioChat;
