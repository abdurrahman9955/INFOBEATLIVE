...
const academyAdvanceClassVideoChat = express.Router();
...
academyAdvanceClassVideoChat.post('/sendVideoMessage/:classId/:userId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
academyAdvanceClassVideoChat.get('/getMessages/:classId', async (req: Request, res: Response) => {
...
academyAdvanceClassVideoChat.put('/updateMessage/:messageId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
academyAdvanceClassVideoChat.delete('/deleteMessage/:messageId', async (req: Request, res: Response) => {
  const { messageId } = req.params;
...
export default academyAdvanceClassVideoChat;
