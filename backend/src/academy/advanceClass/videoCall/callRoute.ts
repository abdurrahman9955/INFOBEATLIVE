...
const academyAdvanceClassVideoCall = Router();

// Route for starting a video call
academyAdvanceClassVideoCall.post('/start/:userId/:classId', async (req, res) => {
...
academyAdvanceClassVideoCall.post('/end/:callId', async (req, res) => {
...
academyAdvanceClassVideoCall.post('/join/:callId/:userId', async (req, res) => {
...
academyAdvanceClassVideoCall.post('/leave/:callId/:userId', async (req, res) => {
  const { callId, userId } = req.params;
  try {
...
export default academyAdvanceClassVideoCall;
