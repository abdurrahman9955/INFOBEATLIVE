...
// Initialize router
const academyBeginnerClassDocumentChat = Router();

// Define allowed document types
const allowedFileTypes = ['application/pdf', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document'];

// Handle uploading a document
academyBeginnerClassDocumentChat.post('/uploadDocument/:classId/:userId', upload, async (req: Request, res: Response) => {
  try {
    if (!req.file) {
...
academyBeginnerClassDocumentChat.get('/getMessages/:classId', async (req: Request, res: Response) => {
  try {
...
academyBeginnerClassDocumentChat.put('/updateDocument/:messageId', upload, async (req: Request, res: Response) => {
  try {
...
academyBeginnerClassDocumentChat.delete('/deleteDocument/:messageId', async (req: Request, res: Response) => {
  try {
    const { messageId } = req.params;
...
export default academyBeginnerClassDocumentChat;
