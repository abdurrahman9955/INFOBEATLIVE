...
// Initialize router
const academyBeginnerClassAudioChat = Router();

// Handle uploading an audio message
academyBeginnerClassAudioChat.post('/uploadAudio/:classId/:userId', upload, async (req: Request, res: Response) => {
  try {
    if (!req.file) {
...
academyBeginnerClassAudioChat.get('/getMessages/:groupId', async (req: Request, res: Response) => {
  try {
...
academyBeginnerClassAudioChat.put('/updateMessage/:messageId', upload, async (req: Request, res: Response) => {
  try {
...
academyBeginnerClassAudioChat.delete('/deleteMessage/:messageId', async (req: Request, res: Response) => {
  try {
    const { messageId } = req.params;
...
export default academyBeginnerClassAudioChat;
