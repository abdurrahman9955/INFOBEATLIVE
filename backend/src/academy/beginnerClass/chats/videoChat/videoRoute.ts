...
const academyBeginnerClassVideoChat = express.Router();
...
academyBeginnerClassVideoChat.post('/sendVideoMessage/:classId/:userId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
academyBeginnerClassVideoChat.get('/getMessages/:classId', async (req: Request, res: Response) => {
...
academyBeginnerClassVideoChat.put('/updateMessage/:messageId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
academyBeginnerClassVideoChat.delete('/deleteMessage/:messageId', async (req: Request, res: Response) => {
  const { messageId } = req.params;
...
export default academyBeginnerClassVideoChat;
