...
const academyBeginnerClassRecordingChat = express.Router();
...
academyBeginnerClassRecordingChat.post('/sendRecordingMessage/:classId/:userId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
academyBeginnerClassRecordingChat.get('/getRecordingMessages/:groupId', async (req: Request, res: Response) => {
...
academyBeginnerClassRecordingChat.put('/updateRecordingMessage/:messageId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
academyBeginnerClassRecordingChat.delete('/deleteRecordingMessage/:messageId', async (req: Request, res: Response) => {
  const { messageId } = req.params;
...
export default academyBeginnerClassRecordingChat;
