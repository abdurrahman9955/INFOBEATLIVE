...
const academyBeginnerClassVoiceCall = Router();

// Route for starting a voice call
academyBeginnerClassVoiceCall.post('/start/:userId/:classId', async (req, res) => {
...
academyBeginnerClassVoiceCall.post('/end/:callId', async (req, res) => {
...
academyBeginnerClassVoiceCall.post('/join/:callId/:userId', async (req, res) => {
...
academyBeginnerClassVoiceCall.post('/leave/:callId/:userId', async (req, res) => {
  const { callId, userId } = req.params;
  try {
...
export default academyBeginnerClassVoiceCall;
