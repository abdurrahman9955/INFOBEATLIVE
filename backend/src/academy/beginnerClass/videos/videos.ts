...
const academyBeginnerClassVideos = Router();
...
academyBeginnerClassVideos.use(express.json());

// Upload Route
academyBeginnerClassVideos.post('/upload', upload.fields([{ name: 'video' }, { name: 'thumbnail', maxCount: 1 }]), async (req: UploadRequest, res: Response) => {
    try {
...
academyBeginnerClassVideos.get('/media/group/:groupId', async (req: Request, res: Response) => {
    try {
...
academyBeginnerClassVideos.get('/media/group/:groupId/user/:userId', async (req: Request, res: Response) => {
    try {
        const { classId, userId } = req.params;
...
// Get Media Route
academyBeginnerClassVideos.get('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Delete Media Route
academyBeginnerClassVideos.delete('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Update Media Route
academyBeginnerClassVideos.put('/media/:id', async (req: Request, res: Response) => {
    try {
        const { title, description } = req.body;
...
export default academyBeginnerClassVideos;