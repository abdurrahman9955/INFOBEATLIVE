...
const academyBeginnerClassShorts = Router();
...
academyBeginnerClassShorts.use(express.json());

// Upload Route
academyBeginnerClassShorts.post('/upload', upload.single('video'), async (req: UploadRequest, res: Response) => {
    try {
...
academyBeginnerClassShorts.get('/media/group/:groupId', async (req: Request, res: Response) => {
    try {
...
academyBeginnerClassShorts.get('/media/group/:groupId/user/:userId', async (req: Request, res: Response) => {
    try {
        const { classId, userId } = req.params;
...
// Get Media Route
academyBeginnerClassShorts.get('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Delete Media Route
academyBeginnerClassShorts.delete('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Update Media Route
academyBeginnerClassShorts.put('/media/:id', async (req: Request, res: Response) => {
    try {
        const { title, description } = req.body;
...
export default academyBeginnerClassShorts;