...
const academyBeginnerClassVideoCall = Router();

// Route for starting a video call
academyBeginnerClassVideoCall.post('/start/:userId/:classId', async (req, res) => {
...
academyBeginnerClassVideoCall.post('/end/:callId', async (req, res) => {
...
academyBeginnerClassVideoCall.post('/join/:callId/:userId', async (req, res) => {
...
academyBeginnerClassVideoCall.post('/leave/:callId/:userId', async (req, res) => {
  const { callId, userId } = req.params;
  try {
...
export default academyBeginnerClassVideoCall;
