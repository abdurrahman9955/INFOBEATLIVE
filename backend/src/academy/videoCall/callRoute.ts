...
const academyVideoCallRouter = Router();

// Route for starting a video call
academyVideoCallRouter.post('/start/:userId/:academyId', async (req, res) => {
  const { userId, academyId } = req.params;
  try {
    const videoCall = await startVideoCall(academyId, userId);
...
academyVideoCallRouter.post('/end/:callId', async (req, res) => {
...
academyVideoCallRouter.post('/join/:callId/:userId', async (req, res) => {
...
academyVideoCallRouter.post('/leave/:callId/:userId', async (req, res) => {
  const { callId, userId } = req.params;
  try {
...
export default academyVideoCallRouter;
