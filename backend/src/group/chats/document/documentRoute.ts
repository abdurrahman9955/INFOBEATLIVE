...
// Initialize router
const groupDocumentChatRouter = Router();

// Define allowed document types
const allowedFileTypes = ['application/pdf', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document'];

// Handle uploading a document
groupDocumentChatRouter.post('/uploadDocument/:groupId/:userId', upload, async (req: Request, res: Response) => {
  try {
    if (!req.file) {
...
groupDocumentChatRouter.get('/getMessages/:groupId', async (req: Request, res: Response) => {
  try {
...
groupDocumentChatRouter.put('/updateDocument/:messageId', upload, async (req: Request, res: Response) => {
  try {
...
groupDocumentChatRouter.delete('/deleteDocument/:messageId', async (req: Request, res: Response) => {
  try {
    const { messageId } = req.params;
...
export default groupDocumentChatRouter;
