...
// Initialize router
const classAudioChatRouter = Router();

// Handle uploading an audio message
classAudioChatRouter.post('/uploadAudio/:classId/:userId', upload, async (req: Request, res: Response) => {
  try {
    if (!req.file) {
...
classAudioChatRouter.get('/getMessages/:groupId', async (req: Request, res: Response) => {
  try {
...
classAudioChatRouter.put('/updateMessage/:messageId', upload, async (req: Request, res: Response) => {
  try {
...
classAudioChatRouter.delete('/deleteMessage/:messageId', async (req: Request, res: Response) => {
  try {
    const { messageId } = req.params;
...
export default classAudioChatRouter;
