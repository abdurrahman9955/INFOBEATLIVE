...
const classVideoChatRouter = express.Router();
...
classVideoChatRouter.post('/sendVideoMessage/:classId/:userId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
classVideoChatRouter.get('/getMessages/:classId', async (req: Request, res: Response) => {
...
classVideoChatRouter.put('/updateMessage/:messageId', upload.single('file'), async (req: Request, res: Response) => {
  try {
    ...
    if (file) {
      ...
      updatedMessage = await prisma.classChat.update({
        where: { id: messageId },
...
classVideoChatRouter.delete('/deleteMessage/:messageId', async (req: Request, res: Response) => {
  const { messageId } = req.params;
...
export default classVideoChatRouter;
