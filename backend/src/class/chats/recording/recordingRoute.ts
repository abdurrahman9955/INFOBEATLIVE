...
const classRecordingChatRouter = express.Router();
...
classRecordingChatRouter.post('/sendRecordingMessage/:classId/:userId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
classRecordingChatRouter.get('/getRecordingMessages/:groupId', async (req: Request, res: Response) => {
...
classRecordingChatRouter.put('/updateRecordingMessage/:messageId', upload.single('file'), async (req: Request, res: Response) => {
  try {
...
classRecordingChatRouter.delete('/deleteRecordingMessage/:messageId', async (req: Request, res: Response) => {
  const { messageId } = req.params;
...
export default classRecordingChatRouter;
