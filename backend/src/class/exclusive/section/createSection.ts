...
export const createSection = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const section = await prisma.exclusiveSection.create({
      data: {
        title,
        instructorId,
        description,
...
export const getAllSections = async (req: Request, res: Response) => {
  try {
    const courses = await prisma.exclusiveSection.findMany({
      include: {
        sections: true,
      },
    });
...
export const getSectionById = async (req: Request, res: Response) => {
  ...
  try {
    const course = await prisma.exclusiveSection.findUnique({
      where: { id,
               courseId,
               instructorId,
       },
...
export const updateSection = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const updatedCourse = await prisma.exclusiveSection.update({
      where: { id,
               courseId,
               instructorId
       },
...
export const deleteSection = async (req: Request, res: Response) => {
  ...
  try {
    await prisma.exclusiveSection.delete({
      where: { id,
       courseId,
       instructorId,
       },
