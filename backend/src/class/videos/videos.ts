...
classVideos.use(express.json());

// Upload Route
classVideos.post('/upload', upload.fields([{ name: 'video' }, { name: 'thumbnail', maxCount: 1 }]), async (req: UploadRequest, res: Response) => {
    try {
...
classVideos.get('/media/group/:groupId', async (req: Request, res: Response) => {
    try {
...
classVideos.get('/media/group/:groupId/user/:userId', async (req: Request, res: Response) => {
    try {
        const { classId, userId } = req.params;
...
// Get Media Route
classVideos.get('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Delete Media Route
classVideos.delete('/media/:id', async (req: Request, res: Response) => {
    try {
...
// Update Media Route
classVideos.put('/media/:id', async (req: Request, res: Response) => {
    try {
        const { title, description } = req.body;
