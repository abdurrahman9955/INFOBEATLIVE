...
const classVoiceCallRouter = Router();

// Route for starting a voice call
classVoiceCallRouter.post('/start/:userId/:classId', async (req, res) => {
...
classVoiceCallRouter.post('/end/:callId', async (req, res) => {
...
classVoiceCallRouter.post('/join/:callId/:userId', async (req, res) => {
...
classVoiceCallRouter.post('/leave/:callId/:userId', async (req, res) => {
  const { callId, userId } = req.params;
  try {
...
export default classVoiceCallRouter;
